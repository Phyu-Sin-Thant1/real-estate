      ...
      {activeTab === 'campaigns' && (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <p className="text-sm text-gray-600">{t('discounts.totalLive')}</p>
            <p className="text-2xl font-bold text-green-600 mt-1">{kpiStats.live}</p>
          </div>
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <p className="text-sm text-gray-600">{t('discounts.totalDraft')}</p>
            <p className="text-2xl font-bold text-gray-600 mt-1">{kpiStats.draft}</p>
          </div>
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <p className="text-sm text-gray-600">{t('discounts.totalPaused')}</p>
            <p className="text-2xl font-bold text-yellow-600 mt-1">{kpiStats.paused}</p>
          </div>
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <p className="text-sm text-gray-600">{t('discounts.endingSoon')}</p>
            <p className="text-2xl font-bold text-orange-600 mt-1">{kpiStats.endingSoon}</p>
          </div>
        </div>
      )}
      {activeTab === 'partner' && (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            ...
            <p className="text-2xl font-bold text-blue-600 mt-1">{kpiStats.submittedDiscounts}</p>
          </div>
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <p className="text-sm text-gray-600">활성 할인</p>
