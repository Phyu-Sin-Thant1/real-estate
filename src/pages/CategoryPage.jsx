...
const CategoryPage = () => {
  ...
  const agencies = getAllAgencies('realEstate')
  ...
  const searchParamsObj = {
    ...
    verifiedAgenciesOnly: verifiedAgenciesOnly || undefined
  }
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-wrap items-center gap-4 mb-6 pb-6 border-b border-gray-200">
          ...
          <div className="relative">
            <select
              ...
              onChange={(e) => {
                ...
                updateSearchParams({ agency: e.target.value || undefined })
              }}
              className="appearance-none bg-white border border-gray-300 rounded-lg px-4 py-2 pr-8 text-sm font-medium text-gray-700 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-dabang-primary focus:border-transparent cursor-pointer min-w-[180px]"
            >
              <option value="">중개사: 전체</option>
              {agencies.map((agency) => (
          ...
          {/* Verified Agencies Only Toggle */}
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              type="checkbox"
              checked={verifiedAgenciesOnly}
              onChange={(e) => {
                setVerifiedAgenciesOnly(e.target.checked)
                updateSearchParams({ verifiedOnly: e.target.checked ? 'true' : undefined })
              }}
              className="w-4 h-4 text-dabang-primary border-gray-300 rounded focus:ring-dabang-primary"
            />
            <span className="text-sm text-gray-700">인증 중개사만</span>
          </label>
