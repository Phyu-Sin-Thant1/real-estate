      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-xl font-bold">TOFU</span>
            </div>
            <p className="text-gray-400 text-sm mb-4">
              대한민국 부동산 정보 플랫폼
            </p>
            <p className="text-gray-400 text-sm">
              © 2023 TOFU. All rights reserved.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/notices" className="text-gray-400 hover:text-white text-sm">
                  공지사항
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          ...
          <div className="mt-8 pt-8 border-t border-gray-800 text-center">
            <p className="text-gray-400 text-sm">
              (주)TOFU | 대표이사: 토푸 | 사업자등록번호: 123-45-67890 | 통신판매업신고번호: 제 2023-서울강남-0123호
            </p>
            <p className="text-gray-400 text-sm mt-2">
              주소: 서울특별시 강남구 테헤란로 123 | 이메일: help@tofu.com | 고객센터: 1234-5678
            </p>
          </div>
        </div>
      </div>
